...
namespace WebApplication1.Tests
{
    ...
    public class ProjectAssignmentControllerTests : IDisposable
    {
        ...
        public ProjectAssignmentControllerTests()
        {
            ...
            var service = new ProjectAssignmentService(repo);
            // יצירת ה-Controller עם הזרקת התלות
            _controller = new ProjectAssignmentController(service);
        }
        ...
        public void GetAllAssignments_ReturnsOkResult_WithListOfAssignments()
        {
            ...
            var assignments = Assert.IsAssignableFrom<List<IProjectAssignment>>(okResult.Value);
        ...
        public void GetAllAssignments_ReturnsCorrectData()
        {
            ...
            var assignments = okResult?.Value as List<IProjectAssignment>;
        ...
        public void GetAssignmentById_WithValidId_ReturnsOkResult_WithAssignment()
        {
            ...
            // Assert
            var okResult = Assert.IsType<OkObjectResult>(result);
            var assignment = Assert.IsType<IProjectAssignment>(okResult.Value);
        ...
        {
            // Arrange
            var newAssignment = new IProjectAssignment
            {
                ProjectId = 2,
                EmployeeId = 2,
            ...
            // Assert
            var okResult = Assert.IsType<OkObjectResult>(result);
            var addedAssignment = Assert.IsType<IProjectAssignment>(okResult.Value);
        ...
        public void AddAssignment_AssignsCorrectId()
        {
            ...
            // Assert
            var okResult = result as OkObjectResult;
            var addedAssignment = okResult?.Value as IProjectAssignment;
        ...
        public void UpdateAssignment_WithValidId_ReturnsOkResult_WithUpdatedAssignment()
        {
            // Arrange
            int assignmentId = 1;
            var updatedData = new IProjectAssignment
            {
                ProjectId = 2,
                EmployeeId = 2,
        ...
        public void GetAssignmentsByProject_WithValidProjectId_ReturnsMatchingAssignments()
        {
            ...
            _context.Assignments.Add(new IProjectAssignment 
            { 
                Id = 2, 
                ProjectId = 1, 
                EmployeeId = 2, 
